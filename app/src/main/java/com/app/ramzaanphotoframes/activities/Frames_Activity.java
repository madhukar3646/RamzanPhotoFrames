...
public class Frames_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frames_recycle_view.setLayoutManager(new GridLayoutManager(Frames_Activity.this, 2));
        Frames_Adapter custom_adapter = new Frames_Adapter(Frames_Activity.this, frame_items);
        frames_recycle_view.setAdapter(custom_adapter);

        frames_recycle_view.addOnItemTouchListener(new RecyclerTouchListener(Frames_Activity.this,
            ...
            public void onClick(View view, final int position) {
                ...
                alertDialog = new Dialog(Frames_Activity.this);
                ...
                gallry.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (ContextCompat.checkSelfPermission(Frames_Activity.this, READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED &&
                                ContextCompat.checkSelfPermission(Frames_Activity.this, WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                ...
                camera.setOnClickListener(new View.OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        if (ContextCompat.checkSelfPermission(Frames_Activity.this, Manifest.permission.CAMERA) ==
                ...
                alertDialog.show();
                Display display1 = ((WindowManager) getSystemService(Frames_Activity.WINDOW_SERVICE)).getDefaultDisplay();
    ...
    private void dispatchTakenPictureIntent() {
        ...
        capturedFileUri = getOutputMediaFileUri(Frames_Activity.this);
    ...
    private void permssiondialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Frames_Activity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == gallery_ReqCode) {
            ...
            if (resultCode == -1) {
                ...
                try {
                    Intent intent = new Intent(Frames_Activity.this, EditingPortraitActivity.class);
