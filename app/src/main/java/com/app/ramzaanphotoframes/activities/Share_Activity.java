...
public class Share_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (shareImage != null)
        {
            Glide.with(Share_Activity.this).load(new File(filepath))
    ...
    public void getPlaystoreApps(){
        Call<PlaystoreappslistingResponse> call= RetrofitApis.Factory.create(Share_Activity.this).getAppsList();
        dialog.show();
            ...
            public void onResponse(Call<PlaystoreappslistingResponse> call, Response<PlaystoreappslistingResponse> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    if(playstoreappslistingResponse!=null)
                    {
                        ...
                        more_app_recycler_view.setAdapter(new AppsParkAdsAdapter(Share_Activity.this,appslist));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.btn_wall) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Share_Activity.this)
        ...
        public void onBindViewHolder(ViewHolder arg0, final int position) {
            ...
            holder.appIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Uri uri = FileProvider.getUriForFile(Share_Activity.this, BuildConfig.APPLICATION_ID + ".provider", new File(filepath));
