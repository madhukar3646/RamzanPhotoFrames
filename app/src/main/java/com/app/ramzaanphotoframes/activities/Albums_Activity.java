...
import com.app.ramzaanphotoframes.adapters.Albums_Adapter;
...
public class Albums_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileimagesgrid.addOnItemTouchListener(new RecyclerTouchListener(this,
            ...
            public void onClick(View view, final int position) {
                ...
                Intent intent = new Intent(Albums_Activity.this, Share_Activity.class);
                pos = position;
    ...
    private void mInterstitialAd_setup() {
        mInterstitialAd = new InterstitialAd(Albums_Activity.this);
